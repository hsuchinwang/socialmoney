...
function loadCurrency() {
  ...
  $.post('http://localhost:4567/find_my_money', {name: name}, function(result) {
      console.log(result);
      var mycur = [];
      var mypri = []; 
...
function updateDB() {
    ...
    $.post('http://localhost:4567/minus', {name: resultName, currency: resultCur, price: resultNum }, function(result) {

      console.log(result);

    });
    $.post('http://localhost:4567/add', {name: creditname, currency: resultCur, price: resultNum}, function(result) {
